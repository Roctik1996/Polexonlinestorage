...
@InjectViewState
public class ShipmentPresenter extends MvpPresenter<ShipmentView> {
    ...
    public void checkShipment(String token,String groupId,String track_no) {
        addBackgroundDisposable(
                ProviderModule.getProvider().checkShipment(token, groupId, track_no)
                        .compose(RxUtils.ioToMainTransformerSingle())
