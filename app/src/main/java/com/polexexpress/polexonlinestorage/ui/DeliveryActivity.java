...
import com.polexexpress.polexonlinestorage.presenter.DeliveryPresenter;
import com.polexexpress.polexonlinestorage.ui.adapter.DeliveryAdapter;
import com.polexexpress.polexonlinestorage.view.DeliveryView;

import java.util.ArrayList;
import java.util.Objects;

public class DeliveryActivity extends MvpAppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, DeliveryView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deliveryPresenter.refreshToken(Const.grant_type_refresh, Const.refresh_token);
        ...
        deliveryPresenter.getGroup(token, group);
    ...
    @Override
    public void getGroup(GroupResult groupResult) {
        data.addAll(groupResult.getContent().getData());
        current = groupResult.getContent().getPageData().getPageNum();
        end = groupResult.getContent().getPageData().getTotalPages();
        if (check) {
    ...
    private View.OnClickListener onItemClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            Intent detail = new Intent(getApplicationContext(), DetailGoodsActivity.class);
            detail.putExtra("id", String.valueOf(data.get(position).getId()));
